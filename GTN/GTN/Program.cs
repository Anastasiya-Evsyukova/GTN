...
namespace GTN
{
    class Program
    {
        ...
        {
            //контейнер для регистрации зависимостей
            var services = new ServiceCollection();

            //регистрация зависимостей
            services.AddTransient<IGameEngine, GameEngine>();   //для каждой игры новый движок. Если бы мы использовали Singleton, то вторая игра использовала бы то же загаданное число
